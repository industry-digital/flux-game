...
export const nightcityCharacters: ActorInput[] = [
  {
    id: createActorUrn(ActorType.NPC, 'rogue'),
  ...
  {
    id: createActorUrn(ActorType.NPC, 'viktor-vector'),
    name: 'Viktor Vector',
  ...
  {
    id: createActorUrn(ActorType.NPC, 'melissa-rory'),
    name: 'Melissa Rory',
  ...
  {
    id: createActorUrn(ActorType.NPC, 'mambo'),
    name: 'Mambo',
