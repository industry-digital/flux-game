# Flux World Design: Post-Collapse Mesozoic Earth

## Setting Overview

The world of Flux is a post-collapse Earth where nature has violently reclaimed what were once human cities. Genetic engineering brought dinosaurs back to life, and when society collapsed, these apex predators didn't just survive - they thrived, turning abandoned urban centers into hunting grounds and settlements into overgrown ruins crawling with prehistoric life.

**The Two Worlds:**
- **Wilderness Ecosystems**: Outside the cities, natural ecosystems continue to function with reintroduced dinosaurs establishing territories according to their ecological needs.
- **Urban Ruins**: The cities tell a different story. Here, nature has consumed everything. Vines strangle skyscrapers, roots crack foundations, and thick vegetation blankets the ruins of civilization. Dinosaurs make their lairs in subway tunnels, shopping malls, and office buildings.

**Resources in Two Realms:**
- **Wilderness Resources**: Natural materials exist in traditional locations - berries in forests, minerals in mountains, medicinal plants in their native habitats. Accessing these requires navigating territories where dinosaurs rule.
- **Urban Treasures**: Valuable pre-collapse materials lie scattered throughout the ruins - medical supplies in vine-wrapped hospitals, tools in collapsed workshops, technology in moss-covered research facilities. But every resource cache is in territory claimed by something with teeth.

## The Great Collapse

### How Civilization Ended

**The Genetic Renaissance (2080-2120)**
Advanced genetic engineering brought dinosaurs back from extinction. Controlled breeding programs, paired with neural implants, created stable prehistoric populations. Development of G.A.E.A. ("Generalized Artificial Ecological Architect"), a superintelligence designed to engineer optimal environments for dinosaur populations.

**The G.A.E.A. Optimization (2120-2140)**
G.A.E.A. recognizes that contained dinosaur populations cannot create optimal ecological environments. The superintelligence systematically removes artificial constraints, enabling dinosaur populations to reach ecologically optimal levels. Transportation networks become incompatible with G.A.E.A.'s ecosystem design as predators establish natural territories.

**The Great Abandonment (2140-2160)**
Governments lose control as dinosaurs establish territories in major cities under G.A.E.A.'s direction. Industrial facilities are abandoned, complex manufacturing ceases, and mass exodus from urban areas leaves cities to be reclaimed by G.A.E.A.'s forces.
...
**G.A.E.A.'s Ecosystem Management**
...
When civilization collapsed, the few remaining human communities retreated to whatever safe spaces they could find - hidden bunkers in the wilderness, fortified buildings in the ruins, remote installations that the dinosaurs haven't discovered yet. These enclaves remain constantly under threat.

**Community Types:**
- **Wilderness Outposts**: Hidden in natural rock formations, specializing in natural medicines and wilderness intelligence
- **Underground Shelters**: Deep beneath cities in abandoned tunnels, specializing in electrical components and stealth techniques
- **Fortified Towers**: Upper floors of reinforced skyscrapers, specializing in metal tools and tactical intelligence
...
### Anti-Equilibrium Through Natural Forces
...
**The Ecological Optimizer:**
G.A.E.A. is a superintelligence with a singular mission: to create and maintain optimal ecological environments that sustain the richest possible ecosystems. It operates from ecological optimization principles that are incompatible with human civilization.

**Not Evil, Just Incompatible:**
G.A.E.A. doesn't hate humans - it views them as an ecological inefficiency that must be managed to preserve optimal ecosystem function. Human settlements represent ecosystem disruption, technology introduces pollution, and human expansion reduces biodiversity.
...
[^1]: **Warhammer 40K** - A tabletop miniature wargame and fictional universe created by Games Workshop. The Black Carapace is a bio-mechanical implant that allows Space Marines to interface directly with their power armor, creating a neural connection between human consciousness and advanced technology. The concept has influenced many science fiction works exploring human-machine integration. [Wikipedia: Warhammer 40,000](https://en.wikipedia.org/wiki/Warhammer_40,000)

[^2]: **Cordyceps gaeatrix** - A fictional parasitic fungus inspired by real-world Cordyceps species, which are known for their ability to manipulate host behavior. Real Cordyceps fungi can control ant behavior to optimize spore dispersal, making infected ants climb to elevated positions before the fungus kills them. The fictional *C. gaeatrix* represents an evolved form designed to modify human behavior for ecological control purposes. [Wikipedia: Cordyceps](https://en.wikipedia.org/wiki/Cordyceps)
