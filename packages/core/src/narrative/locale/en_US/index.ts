...
export const en_US: LanguageTemplates = {
  ...
  [EventType.WORKBENCH_COMPONENT_MOUNTED]: NOT_IMPLEMENTED,
  [EventType.WORKBENCH_COMPONENT_UNMOUNTED]: NOT_IMPLEMENTED,
  [EventType.ACTOR_DID_LIST_SHELLS]: NOT_IMPLEMENTED,
  [EventType.ACTOR_DID_INSPECT_SHELL_STATUS]: NOT_IMPLEMENTED,
  [EventType.ACTOR_DID_REVIEW_SHELL_STATS]: NOT_IMPLEMENTED,
  [EventType.ACTOR_DID_LIST_SHELL_COMPONENTS]: NOT_IMPLEMENTED,
