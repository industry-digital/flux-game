...
const ZERO_COPY_KICK_RESULT: PartyRemovalResult = {
 ...
 */
export const partyKickReducer: Transformer<PartyKickCommand> = withBasicWorldStateValidation(
  withPartyInvitee(
