...
describe('MUTATE_WEATHER Handler', () => {
  ...
  beforeEach(() => {
    ...
    mockContext = createTestTransformerContext({
      world: {
        actors: {},
        places: {
  ...
  describe('mutateWeatherReducer', () => {
    ...
    describe('Error Cases', () => {
      ...
      it('should declare error when places object is empty', () => {
        const emptyWorldContext = createTestTransformerContext({
          world: {
            actors: {},
            places: {}
          }
  ...
  describe('MUTATE_WEATHER Class', () => {
    ...
    describe('handles method', () => {
      ...
      it('should return false for different command types', () => {
        const otherCommand = createCommand(CommandType.TRAVEL, {
          id: 'test-id',
          args: {}
        }) as Command;
  ...
  describe('Type Safety', () => {
    ...
    it('should handle PlaceURN type correctly', () => {
      ...
      const contextWithForest = createTestTransformerContext({
        world: {
          actors: {},
  ...
  describe('Integration Scenarios', () => {
    ...
    it('should handle multiple places with different weather', () => {
      ...
      const multiPlaceContext = createTestTransformerContext({
        world: {
          actors: {},
          places: {
            'flux:place:test-location': mockPlace,
