...
export enum CommandType {
  ...
  WORKBENCH_SHELL_ATTRIBUTE_ADD = 'WORKBENCH_SHELL_ATTRIBUTE_ADD',
  WORKBENCH_SHELL_ATTRIBUTE_REMOVE = 'WORKBENCH_SHELL_ATTRIBUTE_REMOVE',
  CLEANUP_EPHEMERAL_ENTITIES = 'CLEANUP_EPHEMERAL_ENTITIES',
}
