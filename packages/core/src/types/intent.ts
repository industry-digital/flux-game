...
export enum CommandType {
  ...
  WORKBENCH_UNDO = 'WORKBENCH_UNDO',
  WORKBENCH_SWAP = 'WORKBENCH_SWAP',
  WORKBENCH_EXAMINE = 'WORKBENCH_EXAMINE',
  WORKBENCH_MOUNT = 'WORKBENCH_MOUNT',
  WORKBENCH_UNMOUNT = 'WORKBENCH_UNMOUNT',
  WORKBENCH_INCREASE_STAT = 'WORKBENCH_INCREASE_STAT',
}
