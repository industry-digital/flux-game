...
export const DAVID_ID: ActorURN = 'flux:actor:david';
export const DEFAULT_TIMESTAMP: number = 123456789000;
export const DEFAULT_LOCATION: PlaceURN = 'flux:place:test';
