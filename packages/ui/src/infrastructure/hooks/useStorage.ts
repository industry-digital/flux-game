 ...
 * @param storage The storage interface to use (for testability)
 * @returns [T, Dispatch<SetStateAction<T>>]
 */
export const useStorage = <T = any>(key: string, initialValue: T, storage: Storage): [T, Dispatch<SetStateAction<T>>] => {
