...
import { createTerminalHook, DEFAULT_TERMINAL_DEPS, TerminalDependencies } from './useTerminal';
import { createMockTheme, createMockUseTheme, ThemeHook } from '~/theme/index';
...
describe('useTerminal', () => {
  ...
  describe('auto-scrolling', () => {
    it('should auto-scroll when enabled and entries are added', () => {
      ...
      // Mock the scroll methods to verify they're called
      const scrollToBottomSpy = vi.spyOn(result.current, 'scrollToBottom');
  ...
  describe('scroll control', () => {
    ...
    it('should call virtualization scroll methods', () => {
      ...
      // Mock the virtualization methods
      const scrollToBottomSpy = vi.spyOn(result.current.__virtualization, 'scrollToBottom');
      const scrollToTopSpy = vi.spyOn(result.current.__virtualization, 'scrollToTop');
  ...
  describe('memoization and performance', () => {
    it('should return stable function references', () => {
      ...
      expect(firstResult.print).toBe(secondResult.print);
      expect(firstResult.render).toBe(secondResult.render);
